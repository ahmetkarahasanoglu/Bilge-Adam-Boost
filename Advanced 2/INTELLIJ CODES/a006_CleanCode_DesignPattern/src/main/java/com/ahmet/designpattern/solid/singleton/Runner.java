...
//        UrunSingleton urun3 = new UrunSingleton();
        ...
        System.out.println("Nesne 3.....: " + urun3);  // hep aynı nesneler görüntülenir.

//        for(int i=0; i<20; i++) {
//            new Thread(()-> {  // Birden fazla thread, ilk başta nesneyi null olarak gördüğü için farklı nesneler oluşturur. (beklediğimiz gibi çalışmamaktadır, aynı nesne değildir)
