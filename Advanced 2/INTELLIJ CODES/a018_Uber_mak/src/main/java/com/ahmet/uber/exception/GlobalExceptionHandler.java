package com.ahmet.uber.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UberManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSatisManagerException(UberManagerException exception) {
