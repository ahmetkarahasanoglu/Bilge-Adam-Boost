...
public class UserProfileController {
    ...
    public ResponseEntity<Boolean> activateStatus(@RequestHeader(value = "Authorization") String token){ // Dışarıdan gönderdiğimiz String token'ı, Header'a "Authorization" value'suyla set ediyor.
