package com.ahmet.Java6MovieApp.utility;


import com.ahmet.Java6MovieApp.repository.entity.enums.EUserType;
import com.ahmet.Java6MovieApp.service.GenreService;
...
import com.ahmet.Java6MovieApp.utility.data.Sample;
...
//    getAllMovies();                       // İlk verilerin oluşturulması. Programı ilk kez çalıştırdığımızda bu satırlar açık oluyor, daha sonra yorum satırı yapıyoruz.
//    createUser();
